    ...
    def iload(self, arg):
        ...
        for arg in args:
            ...
            if not os.path.isfile(filepath):
                raise ValueError('No boilermagic file named {PROF}. Use %ilist to list all profiles.'.format(PROF=arg))
    ...
    def isave(self,line, cell = None, local_ns = None):
        ...
        if overwrite is not True:
            if os.path.isfile(filepath):
                print 'here'
                raise ValueError('Already Exists, use -o or --overwrite to overwrite file')
